...
class Property(models.Model):
    ...
    date_availability = fields.Date(string="Available From", readonly=False)
    ...
    sales_id = fields.Many2one("res.users", string="Saleman")
    buyer_id = fields.Many2one("res.partner", string="Buyer", domain=[("is_company", "=", True)])
    phone = fields.Char(string="Phone", related="buyer_id.phone")
    # ncc = fields.Char(string="ncc", related="buyer_id.ncc")
